package com.example.camundaoauthresourceserverdemo.filter.webapp;
...
public class SpringSecurityAuthenticationProvider extends ContainerBasedAuthenticationProvider {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SpringSecurityAuthenticationProvider.class);
    ...
    public AuthenticationResult extractAuthenticatedUser(HttpServletRequest request, ProcessEngine engine) {
        ...
        logger.debug("extracted user: {}", name);
